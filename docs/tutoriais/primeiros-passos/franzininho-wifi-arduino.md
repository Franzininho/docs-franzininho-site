---
id: franzininho-wifi-arduino
title: Franzininho WiFi com Arduino
slug: /tutoriais/primeiros-passos/franzininho-wifi-arduino
...
![Download IDE](img/arduino/00-download.png)
...
![Uoload](img/arduino/05-upload.png)

Abra o monitor serial e configure a velocidade para 115200 bps:

![Monitor Serial](img/arduino/06-terminal-serial.png)
