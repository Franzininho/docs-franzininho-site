...
![ligação Conversor USB/Serial](img/ligacao_conversor.jpg)

Selecione na IDE do Arduino a Placa Arduino UNO. Também selecione a porta serial que foi criada ao ser inserido o conversor USB/SERIAL no computador:
